# /users/hbrun/tests/runPFin72/V8 (CMSSW_7_2_1_patch1)

import FWCore.ParameterSet.Config as cms

process = cms.Process( "HLTfancy" )

process.load('Configuration.EventContent.EventContent_cff')
process.load('Configuration.StandardSequences.EndOfProcess_cff')

process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/hbrun/tests/runPFin72/V8')
)
...
process.hltPreCombIsoClusterMu24Unseeded = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltTowerMakerForAll = cms.EDProducer( "CaloTowersCreator",
    ...
    ecalInputs = cms.VInputTag( 'hltCleanOOTEcalRecHit:EcalTimeCleanedRecHitsEB','hltCleanOOTEcalRecHit:EcalTimeCleanedRecHitsEE' ),
...
process.hltParticleFlowRecHitECALUnseeded = cms.EDProducer( "PFRecHitProducer",
    producers = cms.VPSet( 
      cms.PSet(  src = cms.InputTag( 'hltCleanOOTEcalRecHit','EcalTimeCleanedRecHitsEB' ),
      ...
      cms.PSet(  src = cms.InputTag( 'hltCleanOOTEcalRecHit','EcalTimeCleanedRecHitsEE' ),
        qualityTests = cms.VPSet( 
...
process.hltL3MuonTkRelIsolationsIterTrkRegIter02 = cms.EDProducer( "L3MuonCombinedRelativeIsolationProducer",
...
process.hltL3pfIsoTkIsoClusterUnseeded = cms.EDFilter( "HLTMuonIsoFilter",
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL3fL1sMu16L1f0L2f16QL3Filtered24Q" ),
    MinN = cms.int32( 1 ),
    IsolatorPSet = cms.PSet(  ),
    CandTag = cms.InputTag( "hltL3MuonCandidates" ),
    DepTag = cms.VInputTag( 'hltL3MuonTkRelIsolationsIterTrkRegIter02' )
)
...
process.hltL3CaloMuonCorrectedIsolationsNoECAL = cms.EDProducer( "L2MuonIsolationProducer",
    WriteIsolatorFloat = cms.bool( True ),
    IsolatorPSet = cms.PSet( 
      ConeSizesRel = cms.vdouble( 0.3 ),
      EffAreaSFEndcap = cms.double( 0.883 ),
...
process.hltL3CaloMuonCorrectedIsolationsNoHCAL = cms.EDProducer( "L2MuonIsolationProducer",
    WriteIsolatorFloat = cms.bool( True ),
    IsolatorPSet = cms.PSet( 
      ConeSizesRel = cms.vdouble( 0.3 ),
      EffAreaSFEndcap = cms.double( 0.883 ),
...
process.hltMuonSumCaloPFiso= cms.EDProducer( "L3MuonSumCaloPFIsolationProducer",
     recoChargedCandidateProducer = cms.InputTag( "hltL3MuonCandidates" ),
     pfEcalClusterProducer = cms.InputTag( "hltMuonEcalPFClusterIsoUnseeded" ),
     pfHcalClusterProducer = cms.InputTag( "hltMuonHcalPFClusterIsoUnseeded" ),
)


process.hltCleanOOTEcalRecHit = cms.EDProducer("EgammaHLTTimeCleanedRechitProducer",
                                               ecalhitLabels = cms.VInputTag( 'hltEcalRecHit:EcalRecHitsEB','hltEcalRecHit:EcalRecHitsEE' ),
                                               productLabels = cms.vstring('EcalTimeCleanedRecHitsEB','EcalTimeCleanedRecHitsEE'),
...
process.HLTDoFullUnpackingEgammaEcalSequence = cms.Sequence( process.hltEcalDigis + process.hltEcalPreshowerDigis + process.hltEcalUncalibRecHit + process.hltEcalDetIdToBeRecovered + process.hltEcalRecHit + process.hltCleanOOTEcalRecHit + process.hltEcalPreshowerRecHit )
...
process.HLTL3muoncaloPFisorecoSequenceNoBoolsUnseeded = cms.Sequence( process.HLTDoFullUnpackingEgammaEcalSequence + process.HLTDoLocalHcalSequence + process.hltTowerMakerForAll + process.hltFixedGridRhoFastjetAllCaloForMuons + process.HLTPFClusteringUnseeded + process.hltMuonEcalPFClusterIsoUnseeded + process.HLTPFHcalClusteringForMuonsUnseeded + process.hltMuonHcalPFClusterIsoUnseeded )
...
process.HLTTrackReconstructionForTkIsoL3MuonIter02 = cms.Sequence( process.HLTPixelTrackingL3Muon + process.HLTDoLocalStripSequence + process.HLTIterativeTrackingL3MuonIter02 + process.hltL3MuonTkRelIsolationsIterTrkRegIter02 )
process.HLTEndSequence = cms.Sequence( process.hltBoolEnd )
process.HLTL3muoncaloisorecoSequenceNoBools = cms.Sequence( process.HLTDoFullUnpackingEgammaEcalSequence + process.HLTDoLocalHcalSequence + process.hltTowerMakerForAll + process.hltFixedGridRhoFastjetAllCaloForMuons + process.hltL3CaloMuonCorrectedIsolations + process.hltL3CaloMuonCorrectedIsolationsNoECAL + process.hltL3CaloMuonCorrectedIsolationsNoHCAL )
...
process.HLT_IsoClusterMu24_Unseeded_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleMu16 + process.hltPreCombIsoClusterMu24Unseeded + process.hltL1fL1sMu16L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu16L1f0L2Filtered16Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu16L1f0L2f16QL3Filtered24Q + process.HLTL3muoncaloPFisorecoSequenceNoBoolsUnseeded + process.HLTTrackReconstructionForTkIsoL3MuonIter02 + process.hltL3pfIsoTkIsoClusterUnseeded + process.HLTEndSequence )
process.HLT_IsoMu24_IterTrk02_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleMu16 + process.hltPreIsoMu24IterTrk02 + process.hltL1fL1sMu16L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu16L1f0L2Filtered16Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu16L1f0L2f16QL3Filtered24Q + process.HLTL3muoncaloisorecoSequenceNoBools + process.HLTTrackReconstructionForIsoL3MuonIter02 + process.hltL3crIsoL1sMu16L1f0L2f16QL3f24QL3crIsoRhoFiltered0p15IterTrk02 + process.HLTEndSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_IsoClusterMu24_Unseeded_v1, process.HLT_IsoMu24_IterTrk02_v1, process.HLTriggerFinalPath))
...
process.triggerTestProducer = cms.EDAnalyzer('TriggerTest',
                                             ...
                                             pathsToSave           =cms.vstring("HLT_IsoClusterMu24_Unseeded_v1",
                                                                                "HLT_IsoMu24_IterTrk02_v1"
                                                                                ),
                                             filterToMatch           =cms.vstring("hltL3fL1sMu16L1f0L2f16QL3Filtered24Q"),
                                             mapsValues            = cms.vstring("",
                                                                                 "",
                                                                                 "hltL3MuonCombRelIsolationsIterTrkRegIter02",
                                                                                 ""
                                                                                 ),
...
process.runAna = cms.EndPath(process.triggerTestProducer)
